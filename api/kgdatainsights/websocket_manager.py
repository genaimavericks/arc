...
class ConnectionManager:
    ...
    def get_history(self, schema_id: str, limit: int = 20) -> List[Dict[str, Any]]:
        """Get recent message history for a schema"""
        if schema_id not in self.message_history:
            return []
        
        return self.message_history[schema_id][-limit:]

# Singleton instance
connection_manager = ConnectionManager()

def get_connection_manager() -> ConnectionManager:
    """Dependency for FastAPI to get the connection manager instance"""
