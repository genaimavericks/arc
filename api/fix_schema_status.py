...
def fix_schema_status(schema_id: int, db: Session):
    ...
    try:
        ...
        print(f"Schema status updated: db_loaded changed from '{old_value}' to '{schema_record.db_loaded}'")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if success:
            print("Schema status fixed successfully")
        else:
            print("Failed to fix schema status")
    finally:
        db.close()
